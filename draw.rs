...
pub fn add_box(edges: &mut Gmatrix, x:i32, y:i32, z:i32, w:i32, h:i32, d:i32) {
	...
	//RIGHT FACE
	edges.add_tri(x+w,y,z, x+w,y,z-d, x+w,y-h,z-d);
	edges.add_tri(x+w,y-h,z-d, x+w,y-h,z, x+w,y,z);
	//TOP FACE
	edges.add_tri(x+w,y,z-d, x,y,z-d, x,y,z);
	edges.add_tri(x,y,z, x+w,y,z, x+w,y,z-d);
	//BOTTOM FACE
	edges.add_tri(x+w,y-h,z-d, x,y-h,z-d, x,y-h,z);
	edges.add_tri(x,y-h,z, x+w,y-h,z, x+w,y-h,z-d);
}
